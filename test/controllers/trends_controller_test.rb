...
class TrendsControllerTest < ActionController::TestCase
  ...
  test "should create trend" do
    assert_difference('Trend.count') do
      post :create, trend: { category_id: @trend.category_id, category_name: @trend.category_name, created_at: @trend.created_at, name: @trend.name, site_id: @trend.site_id }
    end
  ...
  test "should update trend" do
    patch :update, id: @trend, trend: { category_id: @trend.category_id, category_name: @trend.category_name, created_at: @trend.created_at, name: @trend.name, site_id: @trend.site_id }
    assert_redirected_to trend_path(assigns(:trend))
  end
